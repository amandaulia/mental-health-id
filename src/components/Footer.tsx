        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#professional-counseling" className="text-white/80 hover:text-white transition-colors">
                  Psychologists
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#peer-counseling" className="text-white/80 hover:text-white transition-colors">
                  Peer Counselors
                </a>
              </li>
              <li>
