...
const translations = {
  en: {
    ...
    search: {
      ...
      placeholderAll: "Search all resources",
    ...
    sort: {
      ...
      nearest: "Nearest",
      locationDenied: "Location access is needed to sort by nearest.",
      locationUnavailable: "Your browser could not provide a location. Showing the default order.",
      locationUnsupported: "Your browser does not support location sorting.",
    },
    common: {
      verified: "Verified",
    ...
    seo: {
      home: {
        title: "Psychologists, Psychiatrists & Counseling in Indonesia",
        description:
      ...
      professional: {
        ...
        description:
          "Verified directory of licensed psychologists, psychiatrists, and clinics in Indonesia. Filter by city, specialization, insurance (BPJS), and session mode.",
      },
      peer: {
      ...
      about: {
        ...
        description:
          "Learn about Mental Health Directory Indonesia — a free guide to mental health professionals, peer counseling, and wellness resources in Indonesia.",
      },
    },
    footer: {
      description:
    ...
    detail: {
      ...
      noServicesContactPrefix: "No services information available, contact the",
      noServicesContactSuffix: "for more details.",
      practitionerContactTarget: "practitioner",
      institutionContactTarget: "institution",
      book: "Book",
      ...
      searchInstitutions: "Search affiliated instution",
  ...
  id: {
    ...
    search: {
      ...
      placeholderAll: "Cari semua sumber",
    ...
    sort: {
      ...
      nearest: "Terdekat",
      locationDenied: "Akses lokasi diperlukan untuk mengurutkan berdasarkan jarak terdekat.",
      locationUnavailable: "Browser tidak dapat memberikan lokasi. Menampilkan urutan bawaan.",
      locationUnsupported: "Browser kamu tidak mendukung pengurutan berdasarkan lokasi.",
    },
    common: {
    ...
    seo: {
      home: {
        title: "Direktori Kesehatan Mental Indonesia — Psikolog & Konseling",
        description:
    ...
    detail: {
      ...
      noServicesContactPrefix: "Informasi layanan belum tersedia, hubungi",
      noServicesContactSuffix: "untuk detail lebih lanjut.",
      practitionerContactTarget: "praktisi",
      institutionContactTarget: "institusi",
      book: "Pesan",
      ...
      searchInstitutions: "Cari institusi terkait",
