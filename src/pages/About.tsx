        ...
        <section className="mb-12">
          <div className="bg-card rounded-xl p-8 card-shadow">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground">
              <p className="mb-4">
                The Mental Health Directory is a comprehensive platform designed to help individuals find qualified mental health professionals, 
                support groups, and wellness resources across Indonesia. We understand that seeking mental health support can be overwhelming, 
                and our mission is to make this process easier and more accessible for everyone.
              </p>
              <p>
                Our platform serves as a bridge between those seeking help and qualified professionals, providing detailed information 
                about psychologists, psychiatrists, counseling centers, and various mental health support services available in your area.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="flex items-center space-x-4 p-4 bg-muted/50 rounded-lg">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@mentalhealthdirectory.id" className="text-primary hover:text-primary-hover">
                      info@mentalhealthdirectory.id
                    </a>
                  </div>
                </div>
                <div className="flex items-center space-x-4 p-4 bg-muted/50 rounded-lg">
                  ...
                  <div>
                    ...
                    <a href="tel:+62-21-1234-5678" className="text-primary hover:text-primary-hover">
                      +62-21-1234-5678
                    </a>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="bg-muted/50 rounded-lg p-6 text-center">
                  ...
                  <p className="text-muted-foreground mb-4">Stay updated with our latest resources and mental health tips</p>
                  <a 
                    href="https://instagram.com/mentalhealthdirectory.id" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="inline-flex items-center space-x-2 text-primary hover:text-primary-hover font-medium"
                  >
                    <span>@mentalhealthdirectory.id</span>
